...
const Footer = () => {
  return (
    <div>
      <div className="flex flex-col sm:grid grid-cols-[2fr_1fr_1fr] gap-8 sm:gap-10 my-10 mt-16 sm:mt-24 text-sm">

        <div>
            <img src={assets.logo} alt="" className='mb-5 w-32' />
            <p className='w-full lg:w-2/3 text-gray-600 leading-6'>
        ...
        <div>
            <hr />
            <p className='py-5 text-xs sm:text-sm text-center'>Copyright &copy; 2025@ forever.com -  All rights reserved.</p>
        </div>
